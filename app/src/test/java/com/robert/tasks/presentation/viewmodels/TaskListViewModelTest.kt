...
class TaskListViewModelTest {
    ...
    @Test
    fun `tasks flow should emit tasks from repository`() = runTest {
        val tasks = listOf(
    ...
    @Test
    fun `isRefreshing should be true while refreshing and false after`() = runTest {
    ...
    @Test
    fun `refreshTasks should update tasks flow`() = runTest {
